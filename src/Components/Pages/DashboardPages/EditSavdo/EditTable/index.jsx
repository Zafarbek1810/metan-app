  ...
  const removeCashier = async (cashid) => {
    ...
    new Promise((res, rej) => {
      ...
      .then(async () => {
        ...
        setSavoNuqta((pre) => ({
          ...pre,
          cashiers: pre.cashiers.filter((cash) => cash.id !== cashid),
        }));
  ...
  const removeDirector = async (dirid) => {
    ...
    new Promise((res, rej) => {
      ...
      .then(async () => {
        ...
        setSavoNuqta((pre) => ({
          ...pre,
          directors: pre.directors.filter((dir) => dir.id !== dirid),
        }));
      })
      .catch((err) => {
        console.log(err);
  ...
  const removeCashback = async (keshId) => {
    ...
    new Promise((res, rej) => {
      ...
      .then(async () => {
        ...
        setSavoNuqta((pre) => ({
          ...pre,
          cashback: cashback.filter((cash) => cash.id !== keshId),
        }));
  ...
  return (
    <EditTableWrapper>
      <form onSubmit={handleSubmit(onSubmit)}>
        <h5 style={{ color: "rgba(0, 0, 0, 0.7)", fontFamily: "Rubik" }}>
          Sozlamalar
        </h5>
        <div className="row">
          ...
          <div className="col-md-4 col-12">
            <div className="input">
              ...
              <button
                ...
                disabled={spinLoading1}
              >
                Qo'shish{spinLoading1 && <ButtonLoader />}
              </button>
            </div>
            <div className="box">
          ...
          <div className="col-md-4 col-12">
            <div className="input">
              ...
              <button
                ...
                style={{ fontFamily: "Inter" }}
                className="btn btn-primary"
                disabled={spinLoading2}
              >
                Qo'shish {spinLoading2 && <ButtonLoader />}
              </button>
            </div>
            <div className="box">
          ...
          <div className="col-md-4 col-12">
            <div className="input">
              ...
              <button
                ...
                className="btn btn-primary"
                style={{ fontFamily: "Inter" }}
                disabled={spinLoading3}
              >
                Qo'shish {spinLoading3 && <ButtonLoader />}
              </button>
            </div>
            <Spin spinning={spinLoading3} style={{ display: "flex" }}>
              {savdoNuqta?.cashback ? (
                <h3 className="keshbekTitle">
                  Ishlayotgan keshbek: {savdoNuqta?.cashback?.name}
                </h3>
              ) : (
                <h3 className="keshbekTitle">Keshbek ishlamayapdi</h3>
              )}
              {savdoNuqta?.cashback ? (
                <button
                  style={{ background: "transparent", border: "none" }}
                  type="button"
                  onClick={() => removeCashback(savdoNuqta.cashback.id)}
                >
                  <DeleteSvg />
                </button>
              ) : (
