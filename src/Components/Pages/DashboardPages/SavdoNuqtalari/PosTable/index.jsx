...
import {
  ModalContent,
  ModalHeader,
} from "../../Kassirlar/CashierTable/CashierTable.style";
...
const PosTable = ({ RefObj, setIsOpen }) => {
  ...
  const savdo_edit = useContextSelector(
    GlobalContext,
    (state) => state.savdo_edit
  );
      ...
      <table className="table table-hover table-borderless">
        <thead>
          <tr>
            ...
            <th style={{ width: "8%" }} className="col">
              Ochiq
            </th>
            <th style={{ width: "8%" }} className="col">
              Faollashtirilgan
                  ...
                  <td style={{ width: "10%" }} className="col">
                    <div className="btns">
                      <IconButton
                        ...
                        onClick={() => handleDeleteOutlet(obj.id)}
                        aria-label="delete"
                      >
                        <DeleteIcon />
                      </IconButton>
